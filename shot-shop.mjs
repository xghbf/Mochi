...
await evalJs("(function(){var t=document.querySelector('.garden-tab[data-tab=\"shop\"]');if(t)t.click();return true;})()");
await sleep(600);
const r = await cdp('Page.captureScreenshot', { format: 'jpeg', quality: 40 });
writeFileSync(join(root, 'garden-shop.jpg'), Buffer.from(r.data, 'base64'));
console.log('截图已保存: garden-shop.jpg');
